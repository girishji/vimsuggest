...
# Usage:
#   <Command> <pattern1> <pattern2> ... <pattern5>
...
export def DoComplete(arglead: string, cmdline: string, cursorpos: number,
        cmdstr: string, shellprefix: string = null_string, async: bool = true, max_items: number = 1000): list<any>
